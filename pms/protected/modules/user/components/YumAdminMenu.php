	...
	public function getMenuItems() {
		return array(
				...
				array('label' => 'Groups',
						...
						'items' => array (
							array('label' => 'Groups', 'url' => array('/usergroup/groups/browse')),
							array('label' => 'Create new usergroup', 'url' => array('/usergroup/groups/create')),
							array('label' => 'Assign users to Group', 'url' => array('/usergroup/groups/assign')),
							array('label' => 'Remove users from Group', 'url' => array('/usergroup/groups/remove')),
							),
						),
