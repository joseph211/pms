...
<? echo CHtml::link(Yum::t('Create new Staff'), array(
			'//user/user/create?action=1')); ?>
			
<? echo CHtml::link(Yum::t('Create new Student'), array(
			'//user/user/create?action=2')); ?>
			
<? echo CHtml::link(Yum::t('Import a list of Students'), array(
			'//user/user/import')); ?>
