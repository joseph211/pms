 ...
 * @property YumUser $student
 * @property YumUser $staff
 *
 */
class YumUser extends YumActiveRecord
{
	...
	public function search()
	{
		...
		// Show olderst users first by default
	...
	public function rules()
	{
		...
		$rules[] = array('superuser,student,staff', 'in', 'range' => array(0, 1));
		...
		$rules[] = array('createtime, lastvisit, lastaction, superuser,staff,student, status', 'numerical', 'integerOnly' => true);
	...
	public function scopes()
	{
		return array(
				...
				'student' => array('condition' => 'student = 1',),
				'staff' => array('condition' => 'staff = 1',),
				'public' => array(
	...
	{
		$staffs = YumUser::model()->active()->staff()->findAll();
		$returnarray = array();
		foreach ($staffs as $staff)
			array_push($returnarray, $staff->username);
		return $returnarray;
	}
	
	/**
	 * Return students.
	 * @return array students names
	 */
	public static function getStudents()
	{
		$students = YumUser::model()->active()->student()->findAll();
		$returnarray = array();
		foreach ($students as $student)
			array_push($returnarray, $student->username);
		return $returnarray;
	}
