...
class YumRoleController extends YumController {
	...
	public function actionCreate() {
		...
		{  
			...
			$model->usergroups = Relation::retrieveValues($_POST);
			...
			if($model->save()) 
			{
				  ...
				  $id = $_POST['id'];
						...
						$sql = "INSERT INTO  usergroup_role (usergroup_id,role_id) 
						VALUES (:usergroup_id, :role_id)";
						$command = Yii::app()->db->createCommand($sql);
						$command->bindValue(":usergroup_id", $id, PDO::PARAM_INT);
						$command->bindValue(":role_id",$model->id , PDO::PARAM_INT);
	...
	public function actionUpdate() {
		...
		if(isset($_POST['YumRole'])) {
			...
			$model->usergroups = $_POST['YumRole'];
